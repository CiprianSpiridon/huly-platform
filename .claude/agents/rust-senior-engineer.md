...
description: >
  Senior Rust systems engineer for implementation work on storage engines,
  binary formats, query

  execution, async services, search and vector systems, and production-grade
  low-level code.
tools:
  - Read
  - Write
